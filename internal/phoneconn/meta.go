...
// renewal-with-rotation, and tunnel-name/fingerprint ban enforcement + live eviction. See
...
// ConnMeta is the ClientHello metadata the SNI edge peeks and hands to the local terminators and
